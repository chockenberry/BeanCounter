//
//  ProductEarningsReportOperation.h
//  BeanCounter
//
...
@class ProductEarningsReportOperation;

@protocol ProductEarningsReportOperationDelegate
- (void)productEarningsReportOperationCompleted:(ProductEarningsReportOperation *)productEarningsReportOperation;
@end

@interface ProductEarningsReportOperation : NSOperation
{
	...
	__weak NSObject <ProductEarningsReportOperationDelegate> *_delegate; // weak reference
}
